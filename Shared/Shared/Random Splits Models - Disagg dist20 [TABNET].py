...
#     n_d=1, # nb shared glu for decoding
#     n_a=1, # nb independent glu for decoding
)
...
submission_df_sp.coalesce(1).write.option("header",True).mode("overwrite").csv("/mnt/capstone/test/submission_03_21_featsel_ens_disagg_dist20_randomday.csv") 
